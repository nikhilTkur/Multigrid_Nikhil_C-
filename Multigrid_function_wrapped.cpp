...
public:
	...
	ProblemVar(Eigen::SparseMatrix<double>& coarsest_level_matrix, std::unordered_map<int, csr_matrix_elements>& A_sp_dict,
		std::unordered_map<int, csr_jacobi_elements>& A_jacobi_sp_dict,
		std::unordered_map<int, std::unordered_map<int, int>>& topo_to_space_dict,
		std::unordered_map<int, std::vector<double>>& b_dict,
		std::unordered_map<int, std::vector<std::tuple<int, int>>>& parent_info_dict,
		...
		this->coarsest_level_matrix = coarsest_level_matrix;
		this->A_sp_dict = A_sp_dict;
		this->A_jacobi_sp_dict = A_jacobi_sp_dict;
		this->topo_to_space_dict = topo_to_space_dict;
		this->b_dict = b_dict;
		this->parent_info_dict = parent_info_dict;
		this->coarse_grid_edges_dict = coarse_grid_edges_dict;
	}
};
